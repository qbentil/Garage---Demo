...
const Member = ({ data }) => {
  const { name, role, desc, imgSrc } = data;
  return (
    <div className="items-center bg-gray-50 rounded-lg shadow sm:flex ">
      <div className="flex items-center justify-center w-full p-4 bg-white rounded-lg  sm:w-auto sm:rounded-none">
      <img
      ...
      <div className="p-5">
        ...
        <ul className="flex space-x-4 sm:mt-0">
          <li>
            <p className="text-sky-500 hover:text-sky-900 cursor-pointer">
              <svg
                className="w-5 h-5"
                fill="currentColor"
                viewBox="0 0 24 24"
  ...
  return (
    <section className="w-full my-3 px-6 py-1">
      <div className="w-full flex items-center justify-center flex-col gap-y-3">
        <Title title="Meet Our Team" center />
